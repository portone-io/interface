...
extern PROTOBUF_INTERNAL_EXPORT_escrow_2fescrow_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Info_escrow_2fescrow_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_escrow_2fescrow_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Logis_escrow_2fescrow_2eproto;
namespace escrow {
...
static void InitDefaultsscc_info_EscrowRequest_escrow_2fescrow_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_EscrowRequest_escrow_2fescrow_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_EscrowRequest_escrow_2fescrow_2eproto}, {
      &scc_info_Info_escrow_2fescrow_2eproto.base,
      &scc_info_Logis_escrow_2fescrow_2eproto.base,}};

static void InitDefaultsscc_info_EscrowResponse_escrow_2fescrow_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_EscrowResponse_escrow_2fescrow_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_EscrowResponse_escrow_2fescrow_2eproto}, {
      &scc_info_Logis_escrow_2fescrow_2eproto.base,}};

static void InitDefaultsscc_info_Info_escrow_2fescrow_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Info_escrow_2fescrow_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Info_escrow_2fescrow_2eproto}, {}};

static void InitDefaultsscc_info_Logis_escrow_2fescrow_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Logis_escrow_2fescrow_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Logis_escrow_2fescrow_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_escrow_2fescrow_2eproto[4];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_escrow_2fescrow_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_escrow_2fescrow_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_escrow_2fescrow_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_escrow_2fescrow_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_escrow_2fescrow_2eproto_sccs[4] = {
  &scc_info_EscrowRequest_escrow_2fescrow_2eproto.base,
  &scc_info_EscrowResponse_escrow_2fescrow_2eproto.base,
  &scc_info_Info_escrow_2fescrow_2eproto.base,
  &scc_info_Logis_escrow_2fescrow_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_escrow_2fescrow_2eproto = {
  false, false, descriptor_table_protodef_escrow_2fescrow_2eproto, "escrow/escrow.proto", 425,
...
static bool dynamic_init_dummy_escrow_2fescrow_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_escrow_2fescrow_2eproto)), true);
namespace escrow {
...
void Info::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Info_escrow_2fescrow_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  tel_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  addr_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  postcode_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void Logis::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Logis_escrow_2fescrow_2eproto.base);
  company_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  invoice_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void EscrowRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_EscrowRequest_escrow_2fescrow_2eproto.base);
...
void EscrowResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_EscrowResponse_escrow_2fescrow_2eproto.base);
  message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
