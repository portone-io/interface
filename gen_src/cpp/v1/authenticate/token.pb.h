...
class TokenResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::authenticate::Token* release_response();
...
inline ::authenticate::Token* TokenResponse::_internal_mutable_response() {
  ...
  if (response_ == nullptr) {
    auto* p = CreateMaybeMessage<::authenticate::Token>(GetArenaForAllocation());
    response_ = p;
  }
  return response_;
}
inline ::authenticate::Token* TokenResponse::mutable_response() {
  ::authenticate::Token* _msg = _internal_mutable_response();
...
inline void TokenResponse::set_allocated_response(::authenticate::Token* response) {
  ...
  if (response) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::authenticate::Token>::GetOwningArena(response);
