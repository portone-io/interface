...
inline void Payment::set_emb_pg_provider(const std::string& value) {
...
inline void Payment::set_emb_pg_provider(std::string&& value) {
  
  emb_pg_provider_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:payment.Payment.emb_pg_provider)
}
inline void Payment::set_emb_pg_provider(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  emb_pg_provider_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:payment.Payment.emb_pg_provider)
}
inline void Payment::set_emb_pg_provider(const char* value,
    size_t size) {
  ...
  emb_pg_provider_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:payment.Payment.emb_pg_provider)
}
