...
class GenerateShortenedURLRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_v1_2fsupplements_2flink_2flink_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class GeneratePaymentURLRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  const std::string& payment_info() const;
  void set_payment_info(const std::string& value);
  void set_payment_info(std::string&& value);
  void set_payment_info(const char* value);
  void set_payment_info(const char* value, size_t size);
  std::string* mutable_payment_info();
  std::string* release_payment_info();
  void set_allocated_payment_info(std::string* payment_info);
  private:
  const std::string& _internal_payment_info() const;
  void _internal_set_payment_info(const std::string& value);
  std::string* _internal_mutable_payment_info();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr payment_info_;
  ::PROTOBUF_NAMESPACE_ID::int64 expired_at_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_v1_2fsupplements_2flink_2flink_2eproto;
};
...
// string payment_info = 1;
inline void GeneratePaymentURLRequest::clear_payment_info() {
  payment_info_.ClearToEmpty();
}
inline const std::string& GeneratePaymentURLRequest::payment_info() const {
  // @@protoc_insertion_point(field_get:link_v1.GeneratePaymentURLRequest.payment_info)
  return _internal_payment_info();
}
inline void GeneratePaymentURLRequest::set_payment_info(const std::string& value) {
  _internal_set_payment_info(value);
  // @@protoc_insertion_point(field_set:link_v1.GeneratePaymentURLRequest.payment_info)
}
inline std::string* GeneratePaymentURLRequest::mutable_payment_info() {
  // @@protoc_insertion_point(field_mutable:link_v1.GeneratePaymentURLRequest.payment_info)
  return _internal_mutable_payment_info();
}
inline const std::string& GeneratePaymentURLRequest::_internal_payment_info() const {
  return payment_info_.Get();
}
inline void GeneratePaymentURLRequest::_internal_set_payment_info(const std::string& value) {
  
  payment_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void GeneratePaymentURLRequest::set_payment_info(std::string&& value) {
  
  payment_info_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:link_v1.GeneratePaymentURLRequest.payment_info)
}
inline void GeneratePaymentURLRequest::set_payment_info(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  payment_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:link_v1.GeneratePaymentURLRequest.payment_info)
}
inline void GeneratePaymentURLRequest::set_payment_info(const char* value,
    size_t size) {
  
  payment_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:link_v1.GeneratePaymentURLRequest.payment_info)
}
inline std::string* GeneratePaymentURLRequest::_internal_mutable_payment_info() {
  
  return payment_info_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* GeneratePaymentURLRequest::release_payment_info() {
  // @@protoc_insertion_point(field_release:link_v1.GeneratePaymentURLRequest.payment_info)
  return payment_info_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void GeneratePaymentURLRequest::set_allocated_payment_info(std::string* payment_info) {
  if (payment_info != nullptr) {
    
  } else {
    
  }
  payment_info_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), payment_info,
      GetArena());
