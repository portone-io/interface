...
inline ::PROTOBUF_NAMESPACE_ID::int32 UnitTx::_internal_amount() const {
  return amount_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 UnitTx::amount() const {
  // @@protoc_insertion_point(field_get:basis_v2.UnitTx.amount)
  return _internal_amount();
}
inline void UnitTx::_internal_set_amount(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  amount_ = value;
}
inline void UnitTx::set_amount(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_amount(value);
...
inline ::PROTOBUF_NAMESPACE_ID::int32 UnitTx::_internal_cancel_amount() const {
  return cancel_amount_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 UnitTx::cancel_amount() const {
  // @@protoc_insertion_point(field_get:basis_v2.UnitTx.cancel_amount)
  return _internal_cancel_amount();
}
inline void UnitTx::_internal_set_cancel_amount(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  cancel_amount_ = value;
}
inline void UnitTx::set_cancel_amount(::PROTOBUF_NAMESPACE_ID::int32 value) {
