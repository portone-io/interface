...
inline void GetTxsRecordsRequest::_internal_set_paid_by(const std::string& value) {
  ...
  paid_by_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void GetTxsRecordsRequest::set_paid_by(const char* value) {
  ...
  paid_by_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void GetTxsRecordsRequest::set_paid_by(const char* value,
  ...
  paid_by_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* GetTxsRecordsRequest::_internal_mutable_paid_by() {
  ...
  return paid_by_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
