...
class GetTxsRecordsRequest final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_paid_by(ArgT0&& arg0, ArgT... args);
  std::string* mutable_paid_by();
  PROTOBUF_MUST_USE_RESULT std::string* release_paid_by();
  void set_allocated_paid_by(std::string* paid_by);
  private:
  const std::string& _internal_paid_by() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_paid_by(const std::string& value);
...
class GetTxsRecordsReponse final :
...
void GetTxsRecordsRequest::set_imp_uid(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetTxsRecordsRequest::set_merchant_uid(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetTxsRecordsRequest::set_paid_by(ArgT0&& arg0, ArgT... args) {
 
 paid_by_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* GetTxsRecordsRequest::mutable_paid_by() {
  std::string* _s = _internal_mutable_paid_by();
...
inline void GetTxsRecordsRequest::_internal_set_paid_by(const std::string& value) {
  ...
  paid_by_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* GetTxsRecordsRequest::_internal_mutable_paid_by() {
  
  return paid_by_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* GetTxsRecordsRequest::release_paid_by() {
  ...
  return paid_by_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetTxsRecordsRequest::set_status(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetTxsRecordsRequest::set_sorting(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetTxsRecordsReponse::set_message(ArgT0&& arg0, ArgT... args) {
...
inline ::basis_v2::UnitTx* GetTxsRecordsReponse::add_response() {
  ::basis_v2::UnitTx* _add = _internal_add_response();
