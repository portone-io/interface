...
const UserEditResponse$json = const {
  '1': 'UserEditResponse',
  '2': const [
    const {'1': 'code', '3': 1, '4': 1, '5': 5, '10': 'code'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
...
const UserServiceBase$json = const {
  '1': 'UserService',
  '2': const [
    const {'1': 'UserRegisterRPC', '2': '.user_custompay.UserRegisterRequest', '3': '.user_custompay.UserRegisterResponse', '4': const {}},
    const {'1': 'UserInfoRPC', '2': '.user_custompay.UserRequest', '3': '.user_custompay.UserResponse', '4': const {}},
    const {'1': 'UserDeleteRPC', '2': '.user_custompay.UserRequest', '3': '.user_custompay.UserResponse', '4': const {}},
    const {'1': 'UserEditRPC', '2': '.user_custompay.UserEditRequest', '3': '.user_custompay.UserEditResponse', '4': const {}},
  ],
};

const UserServiceBase$messageJson = const {
  '.user_custompay.UserRegisterRequest': UserRegisterRequest$json,
  '.user_custompay.UserRegisterResponse': UserRegisterResponse$json,
  ...
  '.user_custompay.UserEditResponse': UserEditResponse$json,
};
