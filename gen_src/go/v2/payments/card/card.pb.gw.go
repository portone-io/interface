...
func request_PaymentCardService_GetCardInfoV2RPC_0(ctx context.Context, marshaler runtime.Marshaler, client PaymentCardServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	val, ok = pathParams["card_uid"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "card_uid")
	}

	protoReq.CardUid, err = runtime.String(val)
	if err != nil {
...
// RegisterPaymentCardServiceHandlerServer registers the http handlers for service PaymentCardService to "mux".
// UnaryRPC     :call PaymentCardServiceServer directly.
...
// RegisterPaymentCardServiceHandlerFromEndpoint is same as RegisterPaymentCardServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterPaymentCardServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterPaymentCardServiceHandler(ctx, mux, conn)
}

// RegisterPaymentCardServiceHandler registers the http handlers for service PaymentCardService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterPaymentCardServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterPaymentCardServiceHandlerClient(ctx, mux, NewPaymentCardServiceClient(conn))
}

// RegisterPaymentCardServiceHandlerClient registers the http handlers for service PaymentCardService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "PaymentCardServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "PaymentCardServiceClient"
...
var (
	pattern_PaymentCardService_CardRegisterV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "payments", "v2", "card", "info"}, ""))

	pattern_PaymentCardService_GetCardInfoV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"api", "payments", "v2", "card", "info", "card_uid"}, ""))

	pattern_PaymentCardService_DeleteCardInfoV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"api", "payments", "v2", "card", "info", "card_uid"}, ""))

	pattern_PaymentCardService_PayByRegiseteredCardV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "payments", "v2", "card", "pay", "registered"}, ""))

	pattern_PaymentCardService_CancelRegiseteredCardV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"api", "payments", "v2", "card", "cancel", "registered", "imp_uid"}, ""))
)
