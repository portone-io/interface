...
var (
	pattern_PaymentCardService_CardRegisterV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v2", "card", "info"}, ""))

	pattern_PaymentCardService_GetCardInfoV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "card", "info", "card_uid"}, ""))

	pattern_PaymentCardService_DeleteCardInfoV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "card", "info", "card_uid"}, ""))

	pattern_PaymentCardService_PayByRegiseteredCardV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v2", "card", "pay", "registered"}, ""))

	pattern_PaymentCardService_CancelRegiseteredCardV2RPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v2", "card", "cancel", "registered", "imp_uid"}, ""))
)
