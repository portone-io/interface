...
impl ::protobuf::Message for Http {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.rules)?;
                },
                2 => {
...
impl ::protobuf::Message for HttpRule {
    fn is_initialized(&self) -> bool {
        if let Some(http_rule::Pattern::custom(ref v)) = self.pattern {
            if !v.is_initialized() {
                return false;
            }
        }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                11 => {
                    ::protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.additional_bindings)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
