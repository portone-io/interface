...
export class NestedGetPaidByBillingKeyListData extends jspb.Message {
  ...
  clearListList(): void;
  getListList(): Array<payment_payment_pb.Payment>;
  setListList(value: Array<payment_payment_pb.Payment>): void;
  addList(value?: payment_payment_pb.Payment, index?: number): payment_payment_pb.Payment;
...
export namespace NestedGetPaidByBillingKeyListData {
  export type AsObject = {
    ...
    previous: number,
    next: number,
    listList: Array<payment_payment_pb.Payment.AsObject>,
  }
}
